...
# Index conversion
letter2index = { l : i for i, l in enumerate(constant.LETTER_LIST)}
index2letter = { i : l for i, l in enumerate(constant.LETTER_LIST)}

label2index = { l : i for i, l in enumerate(constant.LABEL_LIST)}
index2label = { i : l for i, l in enumerate(constant.LABEL_LIST)}
